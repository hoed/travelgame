...
import { useWallet, WalletConnectButton } from '../contexts/WalletContext'; // Import the button
import { useLanguage } from '../contexts/LanguageContext';
import './Profile.css';

const Profile = () => {
  const { userStats, achievements } = useGame();
  const { tokenBalance, useNonCryptoMode, toggleNonCryptoMode } = useWallet(); // Removed connectWallet & disconnectWallet
        ...
        {activeTab === 'stats' && (
          <div className="stats-tab">
            <div className="stats-grid">
              ...
              <div className="stat-box">
                <div className="stat-icon">Quests</div>
                <div className="stat-info">
              ...
              <div className="stat-box">
                <div className="stat-icon">Places</div>
                <div className="stat-info">
          ...
          <div className="settings-tab">
            ...
            <div className="settings-section">
              ...
              <div className="wallet-section">
                ...
                {/* Use the beautiful RainbowKit button instead of old connect/disconnect */}
