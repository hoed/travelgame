...
export const GameProvider: React.FC<GameProviderProps> = ({ children }) => {
    ...
    const loadQuestsForRegion = (region: string) => {
        ...
        const allQuests: Record<string, Quest[]> = {
            ...
            // JAVA
            'java': [
                // Central Java - Yogyakarta & Magelang
                {
                    id: 'jv-001',
                    ...
                    location: { name: 'Borobudur, Magelang', lat: -7.6079, lng: 110.2038 },
                    reward: 200,
                    difficulty: 'medium',
                    type: 'visit',
                    completed: false,
                ...
                },
                {
                    ...
                    location: { name: 'Prambanan, Yogyakarta', lat: -7.7520, lng: 110.4915 },
                    reward: 150,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                {
                    id: 'jv-003',
                    title: 'Malioboro Street Shopping',
                    titleId: 'quest.malioboro.title',
                    description: 'Experience the vibrant shopping street of Yogyakarta',
                    descriptionId: 'quest.malioboro.description',
                    location: { name: 'Malioboro, Yogyakarta', lat: -7.7928, lng: 110.3653 },
                    reward: 60,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                {
                    id: 'jv-004',
                    title: 'Yogyakarta Kraton Palace',
                    titleId: 'quest.kraton.title',
                    description: 'Visit the Sultan\'s Palace and learn Javanese culture',
                    descriptionId: 'quest.kraton.description',
                    location: { name: 'Kraton, Yogyakarta', lat: -7.8053, lng: 110.3642 },
                    reward: 90,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                },
                {
                    ...
                    titleId: 'quest.taman_sari.title',
                    description: 'Explore the royal garden and bathing complex',
                    descriptionId: 'quest.taman_sari.description',
                    location: { name: 'Taman Sari, Yogyakarta', lat: -7.8100, lng: 110.3594 },
                    reward: 80,
                    difficulty: 'easy',
                    type: 'photo',
                    completed: false,
                ...
                {
                    id: 'jv-006',
                    title: 'Mendut Temple Visit',
                    titleId: 'quest.mendut.title',
                    description: 'Visit the ancient Buddhist temple near Borobudur',
                    descriptionId: 'quest.mendut.description',
                    location: { name: 'Mendut, Magelang', lat: -7.6044, lng: 110.2306 },
                    reward: 70,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                {
                    id: 'jv-007',
                    title: 'Ketep Pass Merapi View',
                    titleId: 'quest.ketep_pass.title',
                    description: 'Enjoy panoramic views of Mount Merapi',
                    descriptionId: 'quest.ketep_pass.description',
                    location: { name: 'Ketep Pass, Magelang', lat: -7.5167, lng: 110.3667 },
                    reward: 100,
                    difficulty: 'medium',
                    type: 'photo',
                    completed: false,
                ...
                // East Java - Surabaya & Sidoarjo
                {
                    id: 'jv-008',
                    title: 'Surabaya Heroes Monument',
                    titleId: 'quest.tugu_pahlawan.title',
                    description: 'Visit the iconic monument commemorating the Battle of Surabaya',
                    descriptionId: 'quest.tugu_pahlawan.description',
                    location: { name: 'Tugu Pahlawan, Surabaya', lat: -7.2459, lng: 112.7378 },
                    reward: 70,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                },
                {
                    ...
                    titleId: 'quest.sampoerna.title',
                    description: 'Explore the historic cigarette factory museum',
                    descriptionId: 'quest.sampoerna.description',
                    location: { name: 'House of Sampoerna, Surabaya', lat: -7.2333, lng: 112.7333 },
                    reward: 80,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                },
                {
                    ...
                    titleId: 'quest.submarine.title',
                    description: 'Visit the KRI Pasopati submarine museum',
                    descriptionId: 'quest.submarine.description',
                    location: { name: 'Monkasel, Surabaya', lat: -7.2653, lng: 112.7519 },
                    reward: 75,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                {
                    id: 'jv-011',
                    title: 'Surabaya Zoo Adventure',
                    titleId: 'quest.surabaya_zoo.title',
                    description: 'Explore one of the largest zoos in Southeast Asia',
                    descriptionId: 'quest.surabaya_zoo.description',
                    location: { name: 'Kebun Binatang Surabaya', lat: -7.2942, lng: 112.7364 },
                    reward: 90,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                {
                    id: 'jv-012',
                    title: 'Kenjeran Beach Sunset',
                    titleId: 'quest.kenjeran.title',
                    description: 'Watch sunset at Surabaya\'s popular beach',
                    descriptionId: 'quest.kenjeran.description',
                    location: { name: 'Kenjeran Beach, Surabaya', lat: -7.2333, lng: 112.7833 },
                    reward: 65,
                    difficulty: 'easy',
                    type: 'photo',
                    completed: false,
                ...
                {
                    id: 'jv-013',
                    title: 'Sidoarjo Mud Volcano',
                    titleId: 'quest.lumpur_lapindo.title',
                    description: 'Witness the famous Lapindo mud volcano phenomenon',
                    descriptionId: 'quest.lumpur_lapindo.description',
                    location: { name: 'Lumpur Lapindo, Sidoarjo', lat: -7.5275, lng: 112.7117 },
                    reward: 100,
                    difficulty: 'medium',
                    type: 'visit',
                    completed: false,
                ...
                {
                    id: 'jv-014',
                    title: 'Sidoarjo Shrimp Market',
                    titleId: 'quest.pasar_udang.title',
                    description: 'Experience the famous shrimp market of Sidoarjo',
                    descriptionId: 'quest.pasar_udang.description',
                    location: { name: 'Pasar Udang, Sidoarjo', lat: -7.4479, lng: 112.7186 },
                    reward: 60,
                    difficulty: 'easy',
                    type: 'social',
                    completed: false,
                ...
                {
                    id: 'jv-015',
                    title: 'Delta Fishing Sidoarjo',
                    titleId: 'quest.delta_fishing.title',
                    description: 'Enjoy fishing and seafood at Delta Fishing',
                    descriptionId: 'quest.delta_fishing.description',
                    location: { name: 'Delta Fishing, Sidoarjo', lat: -7.4167, lng: 112.7833 },
                    reward: 70,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                {
                    id: 'jv-016',
                    title: 'Candi Pari Temple',
                    titleId: 'quest.candi_pari.title',
                    description: 'Visit the ancient Hindu temple in Sidoarjo',
                    descriptionId: 'quest.candi_pari.description',
                    location: { name: 'Candi Pari, Sidoarjo', lat: -7.4500, lng: 112.7000 },
                    reward: 85,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                // West Java & Jakarta
                {
                    ...
                    location: { name: 'Monas, Jakarta', lat: -6.1754, lng: 106.8272 },
                    reward: 75,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                },
                {
                    ...
                    titleId: 'quest.kota_tua.title',
                    description: 'Explore the historic Dutch colonial area',
                    descriptionId: 'quest.kota_tua.description',
                    location: { name: 'Kota Tua, Jakarta', lat: -6.1352, lng: 106.8133 },
                    reward: 90,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
            ...
            'bali': [
                ...
                },
                {
                    ...
                    description: 'Watch Kecak dance at clifftop temple',
                    descriptionId: 'quest.uluwatu.description',
                    location: { name: 'Uluwatu', lat: -8.8290, lng: 115.0849 },
                    reward: 140,
                    difficulty: 'medium',
                    type: 'visit',
                    completed: false,
                ...
                },
                {
                    ...
                    titleId: 'quest.monkey_forest.title',
                    description: 'Explore sacred forest sanctuary',
                    descriptionId: 'quest.monkey_forest.description',
                    location: { name: 'Monkey Forest', lat: -8.5185, lng: 115.2582 },
                    reward: 100,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                {
                    id: 'bal-006',
                    title: 'Kuta Beach Surfing',
                    titleId: 'quest.kuta_beach.title',
                    description: 'Learn to surf at Bali\'s famous beach',
                    descriptionId: 'quest.kuta_beach.description',
                    location: { name: 'Kuta Beach', lat: -8.7184, lng: 115.1686 },
                    reward: 110,
                    difficulty: 'medium',
                    type: 'challenge',
                    completed: false,
                ...
                {
                    id: 'bal-007',
                    title: 'Seminyak Shopping',
                    titleId: 'quest.seminyak.title',
                    description: 'Explore trendy boutiques and cafes',
                    descriptionId: 'quest.seminyak.description',
                    location: { name: 'Seminyak', lat: -8.6908, lng: 115.1661 },
                    reward: 80,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                },
                {
                    ...
                    titleId: 'quest.kelingking.title',
                    description: 'Visit the T-Rex shaped cliff viewpoint',
                    descriptionId: 'quest.kelingking.description',
                    location: { name: 'Kelingking Beach', lat: -8.7274, lng: 115.4416 },
                    reward: 200,
                    difficulty: 'hard',
                    type: 'photo',
                    completed: false,
                ...
                },
                {
                    ...
                    titleId: 'quest.besakih.title',
                    description: 'Visit Bali\'s largest Hindu temple',
                    descriptionId: 'quest.besakih.description',
                    location: { name: 'Besakih', lat: -8.3742, lng: 115.4508 },
                    reward: 130,
                    difficulty: 'medium',
                    type: 'visit',
                    completed: false,
                ...
                {
                    id: 'bal-010',
                    title: 'Canggu Beach Vibes',
                    titleId: 'quest.canggu.title',
                    description: 'Experience the digital nomad hub',
                    descriptionId: 'quest.canggu.description',
                    location: { name: 'Canggu', lat: -8.6481, lng: 115.1384 },
                    reward: 90,
                    difficulty: 'easy',
                    type: 'visit',
                    completed: false,
                ...
                {
                    id: 'bal-011',
                    title: 'Nusa Lembongan Diving',
                    titleId: 'quest.nusa_lembongan.title',
                    description: 'Dive with manta rays',
                    descriptionId: 'quest.nusa_lembongan.description',
                    location: { name: 'Nusa Lembongan', lat: -8.6833, lng: 115.4500 },
                    reward: 170,
                    difficulty: 'medium',
                    type: 'challenge',
                    completed: false,
                ...
                },
                {
                    ...
                    titleId: 'quest.jatiluwih.title',
                    description: 'UNESCO World Heritage rice fields',
                    descriptionId: 'quest.jatiluwih.description',
                    location: { name: 'Jatiluwih', lat: -8.3667, lng: 115.1333 },
                    reward: 120,
                    difficulty: 'medium',
                    type: 'photo',
                    completed: false,
